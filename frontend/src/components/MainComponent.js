...
import { postContest, fetchContests, editContest, deleteContest} from '../redux/Actions/Contests';
...
const mapDispatchToProps = dispatch => ({
  ...
  fetchQuestions: (student) =>{ dispatch(fetchQuestions(student))},
  ...
  editUser: (id, firstname, lastname, roll, email) => dispatch(editUser(id, firstname, lastname, roll, email)),
  editPassword : (id,username,password) => dispatch(editPassword(id,username,password)),
  postQuestion: (contestId,studentId) => (dispatch(postQuestion(contestId,studentId)))
});
