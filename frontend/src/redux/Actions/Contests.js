import {ADD_CONTEST,ADD_CONTESTS,CONTESTS_FAILED,CONTESTS_LOADING,DELETE_CONTEST,EDIT_CONTEST} from '../ActionTypes';
...
export const postContest = (name, about ) => (dispatch) => {
      ...
      .catch(error =>  { alert('Your contest could not be added\nError: '+error.message); });
  };
...
export const editContest = (id,name, about) => (dispatch) => {
  ...
  export const deleteContest = (id) => (dispatch) => {
    ...
    .catch(error =>  {alert('Your contest could not be deleted\nError: '+error.message); });
  };
