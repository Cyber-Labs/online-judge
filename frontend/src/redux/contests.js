...
const Contests = (state = { isLoading: true,
    errMess: null,
    contests:[]}, action) => {
    switch (action.type) {
        case ActionTypes.ADD_CONTESTS:
            return {...state, isLoading: false, errMess: null, contests: action.payload};
        ...
        case ActionTypes.EDIT_CONTEST:
            ...
            return { ...state, contests: state.contests.map((contest)=>
                {
        ...
        return { ...state, contests: state.contests.filter((contest)=>{
